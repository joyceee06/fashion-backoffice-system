    ...
    <div class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input name="email" type="text" class="form-control" id="customeremail" placeholder="Email"
            pattern="^[^@]+@[^@]+\.[a-zA-Z]{1,}$"
            oninvalid="this.setCustomValidity('Please enter a valid email')"
            oninput="this.setCustomValidity('')" 
            value="<?php if(isset($_GET['edit'])) echo $editrow['fld_email']; ?>"
            required>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input name="phone" type="text" class="form-control" id="customerphonenumeber" placeholder="Phone Number" required
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      <table class="table table-striped table-bordered">  
        ...
        try {
          ...
          $stmt = $conn->prepare("SELECT * FROM tbl_customers_a201392_pt2 LIMIT $start_from, $per_page");
          $stmt->execute();
